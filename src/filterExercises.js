...
export const getFullTimeStudents = () => {
    let fullTimeStudents = students.filter(student => student.fullTime === true);
...
export const getAvailableInstructors = () => {
    let instructorIds = students.map(student => student.instructorId)
    let availableInstructors = instructors.filter(instructor => !instructorIds.includes(instructor.id))
...
export const getStudentsByLanguage = (language) => {
    return students.filter.some(student => student.language === language)
}
